...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <section>
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h3">COD orders</h1>
            <div class="btn-toolbar mb-2 mb-md-0">
               
                <div class="btn-group me-2">
                    <a href="<?= SYSTEM_PATH ?>users/orders/banktransfer.php" class="btn btn-sm btn-outline-secondary">View BankTrans Orders</a>

                </div>
                <div class="btn-group me-2">
                    <a href="<?= SYSTEM_PATH ?>users/receptionist/orders/orders.php" class="btn btn-sm btn-outline-secondary">View All Orders</a>
        ...
        <?php
        $sql = "SELECT * FROM tbl_orders WHERE payementmethod='Cashondelivery' ";
        $db = dbConn();
        $result = $db->query($sql);
