                ...
                if ($results->num_rows > 0) {
                    ...
                    while ($row = $results->fetch_assoc()) {
                        ...
                        <tr>   
                            ...
                            if ($row['Status'] == 1) {
                                ?>
                                 <p><a href="<?= SYSTEM_PATH ?>users/admin/customers/status.php?CustomerId=<?=$row['CustomerId']?>.&Status=0" class="text-success text-decoration-none">Active</a></p> <?php
                            } else {?>
                                <p><a href="<?= SYSTEM_PATH ?>users/admin/customers/status.php?CustomerId=<?=$row['CustomerId']?>.&Status=1" class="text-danger text-decoration-none">Deactive</a></p><?php
                            }
                            ?>
                            </td>
