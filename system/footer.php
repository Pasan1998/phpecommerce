...
<script src="<?= SYSTEM_PATH ?>assets/js/dashboard.js" type="text/javascript"></script>
<script src="<?= SYSTEM_PATH ?>assets/js/sweetalert.min.js" type="text/javascript"></script>
    </body>
</html>