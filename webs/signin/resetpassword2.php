...
//        print_r($resetcustomerid);
        echo $sql = "SELECT * FROM tbl_customers WHERE passwordreset='$token' AND CustomerId=$resetcustomerid";
        $db = dbConn();
    ...
    if (empty($messages)) {
        ...
        echo $sql2 = "UPDATE tbl_customers SET Password = '$newpassword' WHERE CustomerId= '$resetcustomerid'";
